...
export class VideoComponent implements OnInit {
  ayoutCtrl = new FormControl('boxed');
  video :Video[];
  @Input()
  columns: TableColumn<Video>[] = [
    { label: 'Checkbox', property: 'checkbox', type: 'checkbox', visible: true },
    { label: 'Título',property: 'nombreVideo',type: 'text', visible: true, cssClasses: ['text-secondary'] }, 
    { label: 'Descripción',property: 'descripcionVideo',type: 'text', visible: true, cssClasses: ['text-secondary'] }, 
    { label: 'Url',property: 'urlVideo',type: 'text', visible: true, cssClasses: ['text-secondary'] }, 
  ...
  constructor(private snackbar: MatSnackBar,
    ...
    openDialog(listDeber?: Video[], deber?: Video) {
      let message = 'Estas seguro de eliminar este registro?'
      if (deber) {
        listDeber = new Array<Video>();
  ...
  ngOnInit() {
    ...
    /*this.videoService.getDeber().subscribe(
      (data) => { // Success
        this.deber = data;
